...
public class SQLLiteDatabaseHelper extends SQLiteOpenHelper {
    ...
    String TAG = SQLLiteDatabaseHelper.class.getSimpleName();
    String TableName;

    public SQLLiteDatabaseHelper(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version, String TableName) {
    ...
    public void checkTable(){
        ...
        if (cursor != null) {
            if (cursor.getCount() == 0)//numbers of rows
    ...
    public ArrayList<String> getTables(){
        ...
        while (cursor.moveToNext()){
            ...
            if (getTab.contains("android_metadata")){Log.d("tag","This is android_metadata.");}
            else if (getTab.contains("sqlite_sequence")){Log.d("tag","This is sqlite_sequence.");}
